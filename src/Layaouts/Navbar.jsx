...
export const Navbar = () => {
    ...
    return (
        <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            <div className="relative flex sm:grid items-center grid-cols-2 lg:grid-cols-3">
                ...
                <ul className="sm:flex items-center justify-end hidden space-x-8 lg:absolute lg:right-6">

                    {
                        isLogin && loginUser.isVerified ? <li>
